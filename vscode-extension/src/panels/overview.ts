...
export class OverviewPanel {
  ...
  public static render(extensionUri: vscode.Uri, data: any = null) {
...
<body>
  ...
  <main>
    ...
    <section class="card">
      ...
      <div class="signals">
        ${this.data?.signals?.length > 0 ? this.data.signals.map((_: any, i: number) => 
          `<span class="signal-dot" aria-hidden="true" style="animation-delay: ${i * 0.4}s"></span>`
        ).join('') : '<span class="signal-dot" aria-hidden="true"></span>'}
      </div>
